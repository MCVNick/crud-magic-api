...
import './SingleCardButtons.css'

//here we are declaring catbuttons to take in props
const SingleCardButtons = (props) => {
    ...
    return (
        ...
        <div>
            ...
            <button className='button addSingleButton' onClick={() => props.handleCatAddButtonFn(props.id)}>
                +
            </button>
        </div>
    )
...
export default SingleCardButtons